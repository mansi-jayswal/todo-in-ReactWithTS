...
function TodoList() {
  ...
  return (
    <div className="text-center mt-8 w-[min(500px,90%)] mx-auto flex flex-col">
      <h1 className="font-semibold text-purple-900 text-3xl mt-4 mb-2">
        TODO list with React & TS
      </h1>
      <div className="flex justify-center align-center">
        <form
          onSubmit={handleAddTodo}
          className="flex gap-2 w-[95%] mx-auto justify-center items-center"
        >
          <input
            type="text"
          ...
          <button
            type="submit"
            className="border-2 rounded-lg bg-slate-400 p-2 text-black px-8 py-4 hover:bg-gray-300"
          >
            Add
          </button>
        </form>
